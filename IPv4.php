<html>
  ...
  <body>
    <a href = "http://localhost/networkanalyzer/IPv6.php">IPv6 Packet Generator</a>
    <center>
      <!-- Form for taking input-->
    <form method="get" style=" width: 40% ;height: 80%">
      <table border='4'font-size: 24px; style="width: 100%; ">
        <caption style="width: 100%;height: 6%; color: #00ff00; background-color: #222; font-size: 40px">IPv4 packet generator</caption>
        <tr style="width:100%; height:50px"><th style="width:40%; ">Source IPv4 Address</th><th style="width:60%;"><input name="s_ip" value ="192.168.43.168" style="width:100%; height:90%; border-radius: 5px ;border-width:3px "></th></tr>
        <tr style="width:100%; height:50px"><th style="width:40%;">Destination IPv4 Address</th><th style="width:60%;"><input name="d_ip" value ="192.168.43.133" style="width:100%; height:90%; border-radius: 5px;border-width:3px"></th></tr>
        ...
        <tr style="width:100%; height:50px"><th style="width:40%;">InterPacket Gap </th><th style="width:60%;"><input name="timegap" value = 0 style="width:50%; height:90%; border-radius: 5px ;border-width:3px ">Microsec default(0)</th></tr>
  ...
  if(isset($_GET['start']))
  {
    ...
    {
      $shell_command = "sendip -p ipv4 -is ".$sip." -p ".$pro." -d ".$N." -v ".$dip;
      $count--;
      usleep($time);
    }
  }
